...
class DefaultDataProcessor(DataProcessor):
    ...
    def __init__(
            self, in_normalizer=None, out_normalizer=None, device='cuda'
    ):
        """
        Parameters
        ----------
    ...
    def preprocess(self, data_dict, training, batched=True):
        ...
        ----------
        data_dict : dict
            dicts of samples with input data dictionary with at least
    ...
    def forward(self, **data_dict):
        ...
        """
        raise NotImplementedError("Unexpected call of preprocessor forward.")
