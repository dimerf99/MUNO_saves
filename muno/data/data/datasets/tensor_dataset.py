...
#     def __init__(self, x, y, transform_x=None, transform_y=None, in_channels = None, out_channels = None):
...
class TensorDataset(Dataset):
    ...
    def set_idx(self, equation_idx: int = 0):
        self._eq_idx = equation_idx
    ...
    def __getitem__(self, index):
        ...
        # return x, y, self._eq_idx
        return {'x': x, 'y': y, 'eq_idx': self._eq_idx}
