# ----------------------------------------------------------------------------------------------------------------------
# The implementation is taken from https://github.com/neuraloperator/neuraloperator/blob/main/neuralop/models/fno.py
# to separate projection and lifting and make them optional 
# ----------------------------------------------------------------------------------------------------------------------
...
class FNO(BaseModel, name="FNO"):
    ...
    disable_lifting_and_projection : bool, optional
        Flag, if the model shall avoid initializing lifting & projection and contain only FNO blocks.
    ...
    def __init__(
        ...
        disable_lifting_and_projection: bool = False,
        ...
        self._disable_lifting_and_projection = disable_lifting_and_projection
